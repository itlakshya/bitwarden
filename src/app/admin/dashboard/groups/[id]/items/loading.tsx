export default function GroupItemsLoading() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center min-h-[50vh] p-8">
      <div className="flex flex-col items-center gap-4">
        <div className="h-10 w-10 animate-spin rounded-full border-2 border-slate-200 border-t-amber-500" aria-hidden="true" />
        <p className="text-sm font-medium text-slate-600">Loading group items...</p>
