    ...
    <div className="fixed inset-0 lg:left-64 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] w-full max-w-5xl max-h-[90vh] flex flex-col my-8 border border-slate-200/50 overflow-hidden">
        <div className="p-8 border-b border-slate-100 bg-slate-50/60 shrink-0 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-2xl bg-blue-100 text-blue-600 ring-4 ring-blue-50">
        ...
        <form onSubmit={applySearch} className="mx-8 mt-6 flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 bg-slate-50/50 transition-all"
            />
          </div>
          <button
            type="submit"
            className="px-5 py-3 rounded-xl bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 shadow-lg shadow-blue-200/50 transition-all active:scale-[0.98]"
          >
            Search
          </button>
        </form>
              ...
              <div className="p-4 min-h-[200px]">
                {grantedLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-slate-500">
                    ...
                    <p className="text-sm font-medium">No users granted yet</p>
                  </div>
                ) : grantedData ? (
                  <>
                      ...
                      {grantedData.items.map((u) => (
                        ...
                        >
                          ...
                          {u.directGrant ? (
                            ...
                            <span className="shrink-0 text-xs text-slate-400 font-medium">Via parent</span>
                          )}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.2)] max-w-md w-full p-8 border border-slate-200/50 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={actionLoading !== null}
                className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200/50 disabled:opacity-50 transition-all"
              >
